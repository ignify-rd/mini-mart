				...
				<>
					...
					<div className="options">
						...
						<div className="footer">
							<div className="price">
								{!staticCard && <p className="rupee">{getTotalPrice().toLocaleString("vi-VN")}</p>}
								{staticCard && (
									<p className="rupee">
										{item.price.toLocaleString("vi-VN")} <span>✕</span> {item.quantity}
									</p>
								)}
							</div>
							{staticCard ? (
								<div className="totalAmount rupee">{getTotalPrice().toLocaleString("vi-VN")}</div>
							) : (
								<QuantityButton
									className="addToCart"
